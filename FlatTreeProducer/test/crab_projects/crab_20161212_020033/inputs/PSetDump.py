...
process.egmGsfElectronIDs = cms.EDProducer("VersionedGsfElectronIdProducer",
    physicsObjectIDs = cms.VPSet(cms.PSet(
        idDefinition = cms.PSet(
            ...
            idName = cms.string('cutBasedElectronID-Spring15-50ns-V2-standalone-loose')
        ),
        idMD5 = cms.string('527c1b1ddcf9061dc4093dc95590e2bb'),
        isPOGApproved = cms.untracked.bool(True)
    ), 
        cms.PSet(
            idDefinition = cms.PSet(
                ...
                idName = cms.string('cutBasedElectronID-Spring15-50ns-V2-standalone-medium')
            ),
            idMD5 = cms.string('6837f1ac82974f19d2a15041a2e52ebb'),
            isPOGApproved = cms.untracked.bool(True)
        ), 
        cms.PSet(
            idDefinition = cms.PSet(
                cutFlow = cms.VPSet(cms.PSet(
                    ...
                    cms.PSet(
                        barrelCutOff = cms.double(1.479),
                        cutName = cms.string('GsfEleDEtaInCut'),
                        dEtaInCutValueEB = cms.double(0.00864),
                    ...
                    cms.PSet(
                        barrelCutOff = cms.double(1.479),
                        cutName = cms.string('GsfEleDPhiInCut'),
                        dPhiInCutValueEB = cms.double(0.0286),
                    ...
                    cms.PSet(
                        barrelCutOff = cms.double(1.479),
                        cutName = cms.string('GsfEleHadronicOverEMCut'),
                        hadronicOverEMCutValueEB = cms.double(0.0342),
                    ...
                    cms.PSet(
                        barrelCutOff = cms.double(1.479),
                        cutName = cms.string('GsfEleDxyCut'),
                        dxyCutValueEB = cms.double(0.0103),
                    ...
                    cms.PSet(
                        barrelCutOff = cms.double(1.479),
                        cutName = cms.string('GsfEleEInverseMinusPInverseCut'),
                        eInverseMinusPInverseCutValueEB = cms.double(0.0116),
                    ...
                    cms.PSet(
                        ...
                        isIgnored = cms.bool(False),
                        isRelativeIso = cms.bool(True),
                        isoCutEBHighPt = cms.double(0.0591),
                        isoCutEBLowPt = cms.double(0.0591),
                ...
                idName = cms.string('cutBasedElectronID-Spring15-50ns-V2-standalone-tight')
            ),
            idMD5 = cms.string('ab050ff2bd30d832881bfac03c9d3a8a'),
            isPOGApproved = cms.untracked.bool(True)
        ), 
        cms.PSet(
            idDefinition = cms.PSet(
                ...
                idName = cms.string('cutBasedElectronID-Spring15-50ns-V2-standalone-veto')
            ),
            idMD5 = cms.string('3edb92d2aee3dcf1e366a927a5660155'),
            isPOGApproved = cms.untracked.bool(True)
        ), 
        cms.PSet(
            idDefinition = cms.PSet(
...
process.p = cms.Path(process.calibratedPatElectrons+process.electronMVAValueMapProducer+process.egmGsfElectronIDSequence+process.METSignificance+process.BadChargedCandidateFilter+process.BadPFMuonFilter+process.FlatTree+process.calibratedPatElectrons+process.calibratedPatPhotons)
...
process.MessageLogger = cms.Service("MessageLogger",
    ...
    suppressWarning = cms.untracked.vstring('JetPtMismatchAtLowPt', 
...
process.jec = cms.ESSource("PoolDBESSource",
    ...
    connect = cms.string('sqlite_file:Spring16_25nsV10All_DATA.db'),
    timetype = cms.string('runnumber'),
    toGet = cms.VPSet(cms.PSet(
        label = cms.untracked.string('AK4PF'),
        record = cms.string('JetCorrectionsRecord'),
        tag = cms.string('JetCorrectorParametersCollection_Spring16_25nsV10All_DATA_AK4PF')
    ), 
        cms.PSet(
        ...
        cms.PSet(
            ...
            record = cms.string('JetCorrectionsRecord'),
            tag = cms.string('JetCorrectorParametersCollection_Spring16_25nsV10All_DATA_AK8PF')
        ), 
        cms.PSet(
