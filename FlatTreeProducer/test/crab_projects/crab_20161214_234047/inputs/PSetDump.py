...
process.jec = cms.ESSource("PoolDBESSource",
    ...
    connect = cms.string('sqlite_file:Spring16_25nsV10_MC.db'),
    timetype = cms.string('runnumber'),
    toGet = cms.VPSet(cms.PSet(
        label = cms.untracked.string('AK4PF'),
        record = cms.string('JetCorrectionsRecord'),
        tag = cms.string('JetCorrectorParametersCollection_Spring16_25nsV10_MC_AK4PF')
    ), 
        cms.PSet(
        ...
        cms.PSet(
            ...
            record = cms.string('JetCorrectionsRecord'),
            tag = cms.string('JetCorrectorParametersCollection_Spring16_25nsV10_MC_AK8PF')
        ), 
        cms.PSet(
