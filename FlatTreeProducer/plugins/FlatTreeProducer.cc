...
void FlatTreeProducer::analyze(const edm::Event& iEvent, const edm::EventSetup& iSetup)
{
   ...
   ftree->met_passMETFilters = (int)passMETFilters;
...
void FlatTreeProducer::beginRun(const edm::Run& iRun, const edm::EventSetup& iSetup)
{
   ...
   std::string JECUncertaintyPath = std::string(cmssw_base)+"/src/FlatTree/FlatTreeProducer/data/jecFiles/Spring16_25nsV6_MC/Spring16_25nsV6_MC_Uncertainty_AK4PFchs.txt";
